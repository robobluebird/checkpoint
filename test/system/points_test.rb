...
class PointsTest < ApplicationSystemTestCase
  ...
  test "creating a Point" do
    ...
    check "Complete" if @point.complete
    fill_in "Consumer", with: @point.consumer_id
    fill_in "Creator", with: @point.creator_id
    fill_in "Datetime", with: @point.datetime
    fill_in "Latitude", with: @point.latitude
    fill_in "Longitude", with: @point.longitude
    fill_in "Message", with: @point.message
